...
*/
	public static void main(String[] args) throws IOException {
		String excellocation = "C:\\jas-hadoop\\selenium\\data_driven_1.xlsx";
...
//		Object[][] data = excel.getExcelDataBasedOnStartingPoint(excellocation, sheetName, "sheet1");
//		System.out.println(data);
		 excel.updateResult(excellocation, sheetName, "Login Test", "FAIL");
		 excel.updateResult(excellocation, sheetName, "Registration Test",
		 "PASS");
